...
public:
	...
	static constexpr int kEatingGhostScoreCount      = 30;
	static constexpr int kDyingScoreCount            = -100;
	static constexpr int kEatingEnergizerScoreCount = 10;
	static constexpr int kEatingPelletScoreCount     = 1;
