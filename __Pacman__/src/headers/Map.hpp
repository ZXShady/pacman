...
public:
	...
	typename Map::Data& loadSketch(const std::vector<std::string>& sketch) noexcept
	{
		mSketch = &sketch;
		mCells.clear();
		int x = 0;
	...
	typename Map::Data& data() noexcept
	{
		return mData;
	}
	const typename Map::Data& data() const noexcept
	{
		return mData;
	}
